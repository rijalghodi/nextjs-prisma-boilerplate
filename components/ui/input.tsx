...
const inputVariants = cva(
  `
    ...
    focus-visible:ring-ring focus-visible:border-ring focus-visible:outline-none focus-visible:ring-1     
  ...
  `,
  {
    variants: {
      variant: {
        lg: "h-10 px-4 text-base rounded-full file:pe-4 file:me-4",
        md: "h-8.5 px-3 text-sm leading-(--text-sm--line-height) rounded-full file:pe-3 file:me-3",
...
const inputAddonVariants = cva(
  "flex items-center shrink-0 justify-center bg-muted border border-input shadow-xs shadow-[rgba(0,0,0,0.05)] text-secondary-foreground [&_svg]:text-secondary-foreground/60",
  {
    variants: {
      variant: {
        sm: "rounded-full h-7 min-w-7 text-xs px-2.5 [&_svg:not([class*=size-])]:size-3.5",
        md: "rounded-full h-8.5 min-w-8.5 px-3 text-[0.8125rem] leading-(--text-sm--line-height) [&_svg:not([class*=size-])]:size-4.5",
